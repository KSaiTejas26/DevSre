...
export default function RightView() {
  ...
  return (
    <div style={{marginRight:'40px',marginLeft:'40px'}}>
      <h1  style={{ fontSize: '300%',textAlign:'Center'}}>Plants and Flowers</h1>
      <p style={{ fontSize: '20px',textAlign:'center' }}>Our collection of plants & flowers makes it easy for you to spend time among nature.
